...
namespace ServerLibrary.Repositories.Implementations
{
    public class UserAccountRepository(IOptions<JwtSection> config, AppDbContext appDbContext) : IUserAccount
    {
        ...
        public async Task<LoginResponse> RefreshTokenAsync(RefreshToken token)
        {
            ...
            if (user is null) return new LoginResponse(false, "Refresh token could not be generated bcz user not found");
            ...
            if (updateRefreshToken is null) return new LoginResponse(false, "Refresh token could not be generated bcz user has not signed in");
